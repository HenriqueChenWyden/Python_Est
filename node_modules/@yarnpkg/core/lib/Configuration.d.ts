...
import { IdentHash, Package, Descriptor, PackageExtension, Locator } from './types';
export declare const LEGACY_PLUGINS: Set<string>;
...
export declare enum WindowsLinkType {
    JUNCTIONS = "junctions",
    SYMLINKS = "symlinks"
}
...
export declare class Configuration {
    ...
    static addPlugin(cwd: PortablePath, pluginMetaList: Array<PluginMeta>): Promise<void>;
