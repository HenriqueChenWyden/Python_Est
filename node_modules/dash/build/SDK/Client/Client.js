...
var Client = /** @class */ (function (_super) {
    ...
    function Client(options) {
        ...
        if (_this.options.wallet !== undefined) {
            ...
            _this.wallet = new wallet_lib_1.Wallet(__assign({ transport: null, network: _this.network }, _this.options.wallet));
            // @ts-ignore
            _this.wallet.on('error', function (error, context) { return (_this.emit('error', error, { wallet: context })); });
        }
        dapiClientOptions.loggerOptions.identifier = _this.wallet ? _this.wallet.walletId : 'noid';
        _this.dapiClient = new dapi_client_1.default(dapiClientOptions);
        if (_this.wallet) {
            _this.wallet.transport = new DAPIClientTransport_1.default(_this.dapiClient);
        }
