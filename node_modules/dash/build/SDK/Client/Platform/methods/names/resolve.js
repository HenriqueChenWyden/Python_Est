...
function resolve(name) {
    return __awaiter(this, void 0, void 0, function () {
        var normalizedLabel, normalizedParentDomainName, normalizedSegments, document;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (name.includes('.')) {
                        normalizedSegments = convertToHomographSafeChars_1.default(name).split('.');
                        normalizedLabel = normalizedSegments[0];
