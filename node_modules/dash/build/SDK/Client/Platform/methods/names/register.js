            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (records.dashUniqueIdentityId) {
                        records.dashUniqueIdentityId = wasm_dpp_1.Identifier.from(records.dashUniqueIdentityId);
                    }
                    if (records.dashAliasIdentityId) {
                        records.dashAliasIdentityId = wasm_dpp_1.Identifier.from(records.dashAliasIdentityId);
                    }
