...
function createIdentityCreateTransition(assetLockProof, assetLockPrivateKey) {
    return __awaiter(this, void 0, void 0, function () {
        var platform, account, dpp, identityIndex, identityMasterPrivateKey, identityMasterPublicKey, identitySecondPrivateKey, identitySecondPublicKey, identityThirdPrivateKey, identityThirdPublicKey, keyOne, keyTwo, keyThree, identity, identityCreateTransition, _a, masterKey, secondKey, thirdKey;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    identityThirdPrivateKey = account.identities
                        .getIdentityHDKeyByIndex(identityIndex, 2).privateKey;
                    identityThirdPublicKey = identityThirdPrivateKey.toPublicKey();
                    keyOne = new wasm_dpp_1.IdentityPublicKey(1);
                    keyOne.setData(identityMasterPublicKey.toBuffer());
                    keyTwo = new wasm_dpp_1.IdentityPublicKey(1);
                    keyTwo.setId(1);
                    keyTwo.setData(identitySecondPublicKey.toBuffer());
                    keyTwo.setSecurityLevel(wasm_dpp_1.IdentityPublicKey.SECURITY_LEVELS.HIGH);
                    keyThree = new wasm_dpp_1.IdentityPublicKey(1);
                    keyThree.setId(2);
                    keyThree.setData(identityThirdPublicKey.toBuffer());
                    keyThree.setSecurityLevel(wasm_dpp_1.IdentityPublicKey.SECURITY_LEVELS.CRITICAL);
                    identity = dpp.identity.create(assetLockProof.createIdentifier(), [keyOne, keyTwo, keyThree]);
                    identityCreateTransition = dpp.identity.createIdentityCreateTransition(identity, assetLockProof);
                    _a = identityCreateTransition.getPublicKeys(), masterKey = _a[0], secondKey = _a[1], thirdKey = _a[2];
                    return [4 /*yield*/, identityCreateTransition
                            .signByPrivateKey(identityMasterPrivateKey.toBuffer(), wasm_dpp_1.IdentityPublicKey.TYPES.ECDSA_SECP256K1)];
                case 4:
                    _b.sent();
                    masterKey.setSignature(identityCreateTransition.getSignature());
                    identityCreateTransition.setSignature(undefined);
                    return [4 /*yield*/, identityCreateTransition
                            .signByPrivateKey(identitySecondPrivateKey.toBuffer(), wasm_dpp_1.IdentityPublicKey.TYPES.ECDSA_SECP256K1)];
                case 5:
                    _b.sent();
                    secondKey.setSignature(identityCreateTransition.getSignature());
                    identityCreateTransition.setSignature(undefined);
                    return [4 /*yield*/, identityCreateTransition
                            .signByPrivateKey(identityThirdPrivateKey.toBuffer(), wasm_dpp_1.IdentityPublicKey.TYPES.ECDSA_SECP256K1)];
                case 6:
                    _b.sent();
