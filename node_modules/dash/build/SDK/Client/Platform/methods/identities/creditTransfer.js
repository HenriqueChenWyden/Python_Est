...
function creditTransfer(identity, recipientId, amount) {
    return __awaiter(this, void 0, void 0, function () {
        var dpp, identityCreditTransferTransition, signerKeyIndex;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    identityCreditTransferTransition = dpp.identity
                        .createIdentityCreditTransferTransition(identity.getId(), recipientId, BigInt(amount));
                    this.logger.silly('[Identity#creditTransfer] Created IdentityCreditTransferTransition');
                    signerKeyIndex = 2;
                    return [4 /*yield*/, signStateTransition_1.signStateTransition(this, identityCreditTransferTransition, identity, signerKeyIndex)];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, broadcastStateTransition_1.default(this, identityCreditTransferTransition, {
                            skipValidation: true,
                        })];
                case 3:
                    _a.sent();
