...
function update(dataContract, identity) {
    return __awaiter(this, void 0, void 0, function () {
        var dpp, updatedDataContract, dataContractUpdateTransition, _i, _a, appName, appDefinition;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.sent();
                    dpp = this.dpp;
                    updatedDataContract = dataContract.clone();
                    updatedDataContract.incrementVersion();
                    dataContractUpdateTransition = dpp.dataContract
                    ...
                    return [4 /*yield*/, signStateTransition_1.signStateTransition(this, dataContractUpdateTransition, identity, 2)];
                case 2:
                    _b.sent();
