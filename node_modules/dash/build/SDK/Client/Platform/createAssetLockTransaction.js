...
function createAssetLockTransaction(fundingAmount) {
    return __awaiter(this, void 0, void 0, function () {
        var platform, account, assetLockOneTimePrivateKey, assetLockOneTimePublicKey, identityAddress, changeAddress, lockTransaction, output, utxos, balance, selection, realOutput, payload, utxoAddresses, utxoHDPrivateKey, signingKeys, transaction;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    payload = dashcore_lib_1.Transaction.Payload.AssetLockPayload.fromJSON({
                        version: 1,
                        creditOutputs: [{
